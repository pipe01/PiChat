...
Public Class ServerSocket
    ...
    Public Sub enviarMensajeCliente(ByVal IDCliente As Net.IPEndPoint, _
        ...
        Cliente.socketConexion.Send(Encoding.UTF8.GetBytes(Datos))
    End Sub
    ...
    Private Sub EsperarConexionCliente()
        Dim datosClienteActual As datosClienteConectado = Nothing
                ...
                Try
                    ...
                    If Ret > 0 Then
                        ...
                        InfoClienteActual.UltimosDatosRecibidos =
                            Encoding.UTF8.GetString(Recibir)
